...
module.exports = {
    ...
    run: async(client, message, args) => {
        ...
        .setDescription(`${cliente}, \`\`\`Le has agregado con éxito ${cantidad} de reportes solucionados a ${usuario.user.username}\`\`\``)
        .setColor("GREEN")
        .setAuthor("FreshLifeRP","https://cdn.discordapp.com/attachments/847336241490034701/851600464075423754/512x512_sin_mov.png")
        .setFooter("FreshLifeRP | Staff","https://cdn.discordapp.com/attachments/847336241490034701/851600464075423754/512x512_sin_mov.png")
        ...
        .setDescription(`${cliente}, \`\`\`Le has agregado con éxito ${cantidad} de reportes fracasados a ${usuario.user.username}\`\`\``)
        .setColor("GREEN")
        .setAuthor("FreshLifeRP","https://cdn.discordapp.com/attachments/847336241490034701/851600464075423754/512x512_sin_mov.png")
        .setFooter("FreshLifeRP | Staff","https://cdn.discordapp.com/attachments/847336241490034701/851600464075423754/512x512_sin_mov.png")
        ...
        if(args[1].toLowerCase() === 'exito'){
            try {
                ...
                staff_db.sumar(`${usuario.id}.reportesSolucionados`, cantidad)
            } catch (err) {
                console.log(err)
        ...
        if(args[1].toLowerCase() === 'fracasados'){
            try {
                ...
                staff_db.sumar(`${usuario.id}.reportesNoSolucionados`, cantidad)
            } catch (err) {
                console.log(err)
                message.channel.send('¡Ha ocurrido un error!').then(m = m => {m.delete({timeout:5000})})
            }
